...
\thesistitle{CIAABOT: Robótica educativa abierta basada en la CIAA} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
